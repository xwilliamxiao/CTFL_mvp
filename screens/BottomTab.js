...
const BottomTab = () => {
    return (
        ...
        >
            ...
            <Tab.Screen name='Leaderboard' component={LeaderboardScreen} options={{tabBarLabel:'Leaderboard', tabBarIcon:({color, size})=> (<MaterialCommunityIcons name="clipboard-text" color={color} size={size}/>)}}/>
        </Tab.Navigator>
    );
};
